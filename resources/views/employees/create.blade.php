        ...
        <div class="card-body">
            ...
            <div class="row card card-light col-md-11">
                <div class="card-header">
                    {{__('translations.create_new_employee')}}
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group {{ $errors->has('first_name') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="first_name" class="form-control"
                                placeholder="{{__('translations.enter_first_name')}}" value="{{old('first_name')}}">
                        ...
                        <div class="form-group {{ $errors->has('last_name') ? 'has-error' : ''}}">
                            ...
                            <input type="text" name="last_name" class="form-control"
                                placeholder="{{__('translations.enter_last_name')}}" value="{{old('last_name')}}">
                        ...
                        <div class="form-group {{ $errors->has('company_id') ? 'has-error' : ''}}">
                            ...
                            <select name="company_id" class="form-control" >
                                ...
                                <option value="{{$item->id}}"
                                    {{$item->id == old('company_id') ? 'selected' : ''}}>{{$item->name}}
                                </option>
                        ...
                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : ''}}">
                            ...
                            <input type="number" name="phone" class="form-control"
                                placeholder="{{__('translations.enter_phone')}}" value="{{old('phone')}}">
