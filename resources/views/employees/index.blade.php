                ...
                <div class="col-md-9">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="GET" action="{{ route('employee.index') }}" accept-charset="UTF-8"
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>{{ __('translations.company_name') }}</th>
                                ...
                                <div class="pagination-wrapper"> {!! $employees->appends(['search' =>
